...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['logo']) && $_FILES['logo']['error'] !== UPLOAD_ERR_NO_FILE) {
        $logoPath =  $logoPath = uploadCompanyLogo($_FILES['logo'], $companyId);
...
//$file, $companyId
    ...
    if (empty($name)) {
        ...
        // Criar a empresa
        $companyId = createCompany($userId, $name, $logoPath);
            ...
            <div class="card-body">
                <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" enctype="multipart/form-data" novalidate>
                    <div class="mb-3">
                        ...
                        <div class="form-text">Este nome será usado para organizar suas inspeções.</div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">
                            Upload de uma imagem para o logo da empresa (opcional). 
